...
<p align="center">
  <img src="https://github.com/amousaid/amousaid/blob/main/42_badges/cub3de.png" alt="Cub3D 42 project badge"/>
</p>
...
```shell
git clone --recursive https://github.com/amousaid/cub3D.git
```

Or:

```shell
git clone https://github.com/amousaid/cub3D.git
